...
public class RobotVideo extends BorderPane {
    ...
    public RobotVideo(Stage s) {
        ...
        if(RobotMode.win == true){
            winStatus = "Congratulations!";
            playerNumber.setText("You Win");
            path = getClass().getResource("/tictactoe/videos/winner.mp4").toExternalForm();
            image = new Image(getClass().getResource("/tictactoe/images/winnerIcon.png").toExternalForm());
        }else{
            winStatus = "     Good Luck!";
            playerNumber.setText("You Lose");
            path = getClass().getResource("/tictactoe/videos/looser.mp4").toExternalForm();
            image = new Image(getClass().getResource("/tictactoe/images/loser.png").toExternalForm());
        }
        ...
        winPlayAgainBtn.setOnAction(new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent event) {
                mediaPlayer.stop();
                Welcome.navScreens(new RobotMode(s), s);
            }});
